...
<template>
  <div id="app">
    ...
    <!--
      In v-on, 'student-added' is an event from the 'addStudent' method of the child NewStudentForm.vue, and the value 'newStudentAdded' method is from the parent App.vue.
    -->
    ...
    <!--
      ...
      In the 1st v-on, the 'student-arrived-or-left' is an event from the 'arrivedOrLeft' method of the child StudentTable.vue, and the value 'studentArrivedOrLeft' method is from the parent App.vue.

      In the 2nd v-on, the 'delete-student' is an event from the 'deleteStudent' method of the
      child StudentTable.vue, which is getting this event from its' child the StudentRow.vue component and the value 'studentDeleted' method is from the parent App.vue.
    -->
    <student-table
    ...
    <!--
      ...
      In v-bind, the first 'student' is the name of the prop from the child StudentMessage.vue, and the value 'mostRecentStudent' is data from the parent App.vue.
    -->
