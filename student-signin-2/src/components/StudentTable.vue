      ...
      <div id="student-table">
        <table class="table">
          ...
          <!--
            ...
            In the 1st v-bind, the first 'student' is a prop from the child StudentRow.vue, and the value 'student' is the variable from the v-for.

            v-on is to receive the event from the child component here.
            In the 1st v-on, the 'student-arrived-or-left' is an event from the child StudentRow.vue, and the value 'arrivedOrLeft' is the method from this component, StudentTable.vue.

            In the 2nd v-on, the 'delete-student' is an event from the child StudentRow.vue, and the value 'deleteStudent' is the method from this component, StudentTable.vue.
          -->
          <tbody>
            <student-row
...
export default {
  // register the child component here
  components: {
    StudentRow,
  },
